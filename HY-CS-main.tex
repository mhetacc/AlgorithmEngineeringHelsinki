...
\ Software and its engineering $\rightarrow$ Software creation and management $\rightarrow$ Designing software $\rightarrow$ Software design engineering\ \\
...
\  Theory of computation $\rightarrow$ Design and analysis of algorithms $\rightarrow$ Algorithm design techniques $\rightarrow$ Divide and conquer\ \\
\  Information systems $\rightarrow$ Information retrieval $\rightarrow$ Document representation $\rightarrow$ Data encoding and canonicalization\ \\
\  Information systems $\rightarrow$ Information retrieval $\rightarrow$ Information retrieval query processing $\rightarrow$ Query representation\ \\
\  Applied computing $\rightarrow$ Document management and text processing $\rightarrow$ Document searching
}}
